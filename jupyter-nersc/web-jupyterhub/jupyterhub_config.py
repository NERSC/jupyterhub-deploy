...
c.NERSCSpawner.spawners = {
    "gerty-shared-node-cpu": (
        "sshspawner.sshspawner.SSHSpawner", {
            "cmd": ["/global/common/cori/das/jupyterhub/jupyter-launcher.sh", 
                "/global/common/cori_cle7/software/jupyter/cori/20-10/bin/jupyterhub-singleuser"],
            "args": ["--transport=ipc"],
            ...
            "path": "/global/common/cori_cle7/software/jupyter/cori/20-10/bin:/global/common/cori/das/jupyterhub:/usr/common/usg/bin:/usr/bin:/bin",
            "ssh_keyfile": '/certs/{username}.key'
        }
    ),
    "gerty-exclusive-node-cpu": (
        "nerscslurmspawner.NERSCExclusiveSlurmSpawner", {
            "cmd": ["/global/common/cori_cle7/software/jupyter/cori/20-10/bin/jupyterhub-singleuser"],
            ...
            "batchspawner_singleuser_cmd" : " ".join([
                ...
                "/global/common/cori_cle7/software/jupyter/cori/20-10/bin/batchspawner-singleuser",
            ])
        }
    ),
    ...
    "cori-shared-node-gpu": (
        "nerscslurmspawner.NERSCExclusiveGPUSlurmSpawner", {
            "cmd": ["/global/common/cori_cle7/software/jupyter/cgpu/20-10/bin/jupyterhub-singleuser"],
            "args": ["--transport=ipc"],
            "exec_prefix": "/usr/bin/ssh -q -o StrictHostKeyChecking=no -o preferredauthentications=publickey -l {username} -i /certs/{username}.key {remote_host}",
            "startup_poll_interval": 30.0,
            ...
            "req_runtime": "240",
            "hub_api_url": f"https://{nersc_jupyterhub_subdomain}.nersc.gov/hub/api",
            "path": "/global/common/cori_cle7/software/jupyter/cgpu/20-10/bin:/global/common/cori/das/jupyterhub:/usr/common/usg/bin:/usr/bin:/bin",
            "batchspawner_singleuser_cmd" : " ".join([
                "/global/common/cori/das/jupyterhub/jupyter-launcher.sh",
                "/global/common/cori_cle7/software/jupyter/cgpu/20-10/bin/batchspawner-singleuser",
            ])
        }
    ),
