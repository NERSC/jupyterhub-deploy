...
c.JupyterHub.internal_certs_location = os.environ.get('INTERNAL_SSL_PATH', 'internal-ssl')
...
c.JupyterHub.trusted_alt_names = ['DNS:proxy', 'DNS:app', 'DNS:web', 'DNS:announcement',
